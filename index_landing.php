...
<head>
<meta charset="UTF-8">
<title>Tech Contact Manager - Landing Page</title>
...
<nav class="fixed top-0 w-full bg-white shadow-md z-50">
    <div class="max-w-7xl mx-auto flex justify-between items-center p-6">
        <h1 class="text-2xl font-bold text-purple-700">Tech Contact</h1>
        <div class="space-x-4">
...
<section class="text-center mt-28 px-6 md:px-0 py-20 bg-gradient-to-r from-purple-300 via-purple-400 to-purple-500">
    ...
    <p class="text-purple-100 text-lg mb-8 max-w-2xl mx-auto">Tech Contact Manager membantu Anda mengorganisir, menambahkan, dan memantau kontak dengan mudah. Profesional, modern, dan efisien.</p>
</section>

<!-- Features + CTA Section full putih -->
